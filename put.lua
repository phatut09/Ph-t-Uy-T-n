...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>Phát UT chào ae<Color=/>"):Display()
    wait(.5)
    ...
    wait(.29)
    require(game.ReplicatedStorage.Notification).new("<Color=Yellow>Đăng ký kênh Nhật Roblox Mod để xem video mới nhất nhé<Color=/>"):Display()
    wait(.36)
end)

local OrionLib = loadstring(game:HttpGet(('https://raw.githubusercontent.com/shlexware/Orion/main/source')))()
local Window = OrionLib:MakeWindow({Name = "Phát UT", HidePremium = false, IntroText = "Phát UT⚜️", SaveConfig = true, ConfigFolder = "NightHub"})
...
W:AddLabel("Phát UT SCRIPT")
W:AddLabel("DiscordPhát UT")
local Section = W:AddSection({
    Name = "Status"
})
